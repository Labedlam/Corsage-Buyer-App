    ...
    describe('Factory: RepeatOrderFactory', function() {
        ...
        describe('CheckLineItemsValid', function() {
            ...
            it('should display warning toaster if some of the line items are invalid', function() {
                ...
                repeatFactory.CheckLineItemsValid('buyer', mockOrderID);
                scope.$digest();
                expect(toaster.warning).toHaveBeenCalledWith("There are 1 product(s) in your cart that either no longer exist or you do not have permission to reorder, the order will process only with the products you are able to order. The ID's of the products that have been excluded are: ProductID123");
            });
